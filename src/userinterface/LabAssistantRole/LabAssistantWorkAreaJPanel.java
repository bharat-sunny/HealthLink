...
public class LabAssistantWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private LabAssistantOrganization labOrganization;
    ...
    public LabAssistantWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, Organization organization, EcoSystem business) {
        ...
        this.labOrganization = (LabAssistantOrganization) organization;
    ...
    public void populateTable() {
        ...
        for (WorkRequest request : labOrganization.getWorkQueue().getWorkRequests()) {
            ...
            row[2] = ((PatientVisitWorkRequest) request).getLabAssistant();
            row[3] = request.getStatus();
            row[4] = ((PatientVisitWorkRequest) request).getPatient().getPatientFirstName() + " " + ((PatientVisitWorkRequest) request).getPatient().getPatientLastName();
            row[5] = ((PatientVisitWorkRequest) request).getPatient().getPatientId();
            model.addRow(row);
        }
    }
    ...
    private void initComponents() {
        ...
        assignJButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/userinterface/IconsImages/assign.png"))); // NOI18N
        ...
        processJButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/userinterface/IconsImages/yes.png"))); // NOI18N
        ...
        add(processJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 190, 110, 50));
    ...
    private void assignJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_assignJButtonActionPerformed
        ...
        PatientVisitWorkRequest request = (PatientVisitWorkRequest) workRequestJTable.getValueAt(selectedRow, 0);
    ...
    private void processJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_processJButtonActionPerformed
       ...
       // request.setStatus("Processing");
        LabAssitantProcessRequestJPanel processWorkRequestJPanel = new LabAssitantProcessRequestJPanel(userProcessContainer, request);
        if (request.getLabAssistant() != null) {
            if (userAccount.equals(request.getLabAssistant())) {
