...
public class DoctorWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public void populateRequestTable() {
        ...
        for (WorkRequest request : doctorOrganization.getWorkQueue().getWorkRequests()) {
            ...
            row[0] = ((PatientVisitWorkRequest) request).getRegistrationDate();
            row[1] = String.valueOf(((PatientVisitWorkRequest) request).getPatient().getPatientId());
            row[2] = ((PatientVisitWorkRequest) request).getPatient().getPatientFirstName() + " " + ((PatientVisitWorkRequest) request).getPatient().getPatientLastName();
            row[3] = ((PatientVisitWorkRequest) request);
            row[4] = ((PatientVisitWorkRequest) request).getAssignedDoctor();
            row[5] = ((PatientVisitWorkRequest) request).getLabAssistant();
            row[6] = ((PatientVisitWorkRequest) request).getLabResult();
...
//            }
    ...
    private void initComponents() {
        ...
        requestTestJButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/userinterface/IconsImages/lab.png"))); // NOI18N
        ...
        btnProvidePrescription.setIcon(new javax.swing.ImageIcon(getClass().getResource("/userinterface/IconsImages/prescription.png"))); // NOI18N
        ...
        btnComplete.setIcon(new javax.swing.ImageIcon(getClass().getResource("/userinterface/IconsImages/yes.png"))); // NOI18N
        ...
        btnViewPatient.setIcon(new javax.swing.ImageIcon(getClass().getResource("/userinterface/IconsImages/view.png"))); // NOI18N
    ...
    private void requestTestJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_requestTestJButtonActionPerformed
        ...
        PatientVisitWorkRequest workRequest;

        if (selectedRow < 0) {
            JOptionPane.showMessageDialog(null, "Please select a row");
            return;
        } else {
            workRequest = (PatientVisitWorkRequest) workRequestJTable.getValueAt(selectedRow, 3);
    ...
    private void btnAssignToMeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAssignToMeActionPerformed
        ...
        if (selectedRow < 0) {
            ...
            WorkRequest patientTreatmentWorkRequest = (PatientVisitWorkRequest) workRequestJTable.getValueAt(selectedRow, 3);
            if (((PatientVisitWorkRequest) patientTreatmentWorkRequest).getAssignedDoctor() == null) {
                ...
                if (patientTreatmentWorkRequest.getStatus().equalsIgnoreCase("Waiting for Doctor")) {
                    ...
                    ((PatientVisitWorkRequest) patientTreatmentWorkRequest).setAssignedDoctor(userAccount);
                ...
                if(userAccount.equals(((PatientVisitWorkRequest) patientTreatmentWorkRequest).getAssignedDoctor())) {
    ...
    private void btnViewPatientActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewPatientActionPerformed
        int selectedRow = workRequestJTable.getSelectedRow();
        PatientVisitWorkRequest patientWorkRequest;

        if (selectedRow < 0) {
            JOptionPane.showMessageDialog(null, "Please select a row");
            return;
        } else {
            patientWorkRequest = (PatientVisitWorkRequest) workRequestJTable.getValueAt(selectedRow, 3);
            CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        ...
        if (selectedRow < 0) {
            ...
            if (userAccount.equals(workRequest.getAssignedDoctor())) {
                if (workRequest.getStatus().equalsIgnoreCase("Lab Test Completed") || workRequest.getStatus().equalsIgnoreCase("Under Consultation")) {
                    ...
                    CardLayout layout = (CardLayout) userProcessContainer.getLayout();
                    userProcessContainer.add("ProvidePrescriptionJPanel", new ProvidePrescriptionsJPanel(userProcessContainer, userAccount, enterprise, workRequest));
                    layout.next(userProcessContainer);
                } else {
