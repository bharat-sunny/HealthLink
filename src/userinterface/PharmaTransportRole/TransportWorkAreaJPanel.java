...
public class TransportWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private TransportOrganization treasurerOrganization;
    private Enterprise enterprise;

    public TransportWorkAreaJPanel(JPanel jpanel, UserAccount userAccount, Organization organization, Enterprise enterprise) {
        initComponents();
        this.enterprise = enterprise;
        this.jPanel = jpanel;
        this.treasurerOrganization = (TransportOrganization) organization;
...
//        populateTable();
    ...
    private void requestGovSecretaryBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_requestGovSecretaryBtnActionPerformed
        ...
        if (selectedRow < 0) {
            ...
            TransportProcessRequestJPanel transportProcessWorkRequestJPanel = new TransportProcessRequestJPanel(jPanel, request);
